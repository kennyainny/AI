...
class CustomPlayer:
    ...
    def move(self, game, legal_moves, time_left):
        ...
        self.backup_time = time_left()*0.15
        ...
        if game.move_count > 9:
            ...
            new_depth = 5 #can go deep cos alpha-bet is in effect

        # best_move, utility_val = self.alphabeta(game, time_left, depth=new_depth)

        # while (time_left() > self.backup_time and new_depth<50):  # keep looping as long as there is time
